...
if __name__ == "__main__":
    ...
    for img in os.listdir('you_shall_not_mark/you_shall_not_mark/battle_images'):
        image = cv2.imread('you_shall_not_mark/you_shall_not_mark/battle_images/' + img, 0)
        
        watermarked = embedding(image, mark)
        cv2.imwrite('you_shall_not_mark/you_shall_not_mark/battle_watermarked_images/' + img[:-4] + '_youshallnotmark.bmp', watermarked)
        w = wpsnr(image, watermarked)
        print('wPSNR', img, ': %.2fdB' % w)
